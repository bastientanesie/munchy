 ...
 */
TannsEngine.Chatbox.prototype.addMessage = function(message)
{
 ...
 */
TannsEngine.Chatbox.prototype.addMessageFrom = function (message, username)
{
	var html = '',
		date = new Date();
 ...
 * @param {String} type
 */
TannsEngine.Chatbox.prototype.log = function(message, type)
{
